...
import PickToFinishMultipleDevices from './pick-to-finish-multi-devices';
      ...
      {!gameId ? (
        <>
          <StepProgress
            ...
            onFinalStep={createNewGame}
            finalStepBtnLabel="Create Game!"
          />
          <NotificationHub
            timeout={5000}
            variant="warn"
